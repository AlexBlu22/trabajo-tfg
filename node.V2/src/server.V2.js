...
/*
app.get('/myBar/login', (req, res) => {
    res.sendFile(path.resolve(__dirname, './routes/views/html/...'));
});
*/

// Ruta para el registro [http://localhost:3000/myBar/registro]
/*
app.get('/myBar/registro', (req, res) => {
    res.sendFile(path.resolve(__dirname, './routes/views/html/...'));
});
*/
...
app.get('/myBar/usuario', (req, res) => {
    res.sendFile(path.resolve(__dirname, './routes/views/html/usuario/usuario.html'));
});


// Ruta para visualizar todos los bares [http://localhost:3000/myBar/usuario/bares]
/*
app.get('/myBar/usuario/bares', (req, res) => {
    res.sendFile(path.resolve(__dirname, './routes/views/html/...'));
});
*/
...
/*
app.get('/myBar/usuario/bares/informacion', (req, res) => {
    res.sendFile(path.resolve(__dirname, './routes/views/html/...'));
});
*/
...
/*
app.get('/myBar/usuario/pedidos_usuario', (req, res) => {
    res.sendFile(path.resolve(__dirname, './routes/views/html/...'));
});
*/
...
/*
app.get('/myBar/usuario/configuracion_usuario', (req, res) => {
    res.sendFile(path.resolve(__dirname, './routes/views/html/...'));
});
*/
...
app.get('/myBar/bar', (req, res) => {
    res.sendFile(path.resolve(__dirname, './routes/views/html/bar/bar.html'));
});


// Ruta para la pagina de pedidos entrantes del bar [http://localhost:3000/myBar/bar/pedidos_entrantes]
/*
app.get('/myBar/bar/pedidos_entrantes', (req, res) => {
    res.sendFile(path.resolve(__dirname, './routes/views/html/...'));
});
*/
...
/*
app.get('/myBar/bar/pedidos_entrantes/estado_pedido', (req, res) => {
    res.sendFile(path.resolve(__dirname, './routes/views/html/...'));
});
*/
...
/*
app.get('/myBar/bar/configuracion_menu', (req, res) => {
    res.sendFile(path.resolve(__dirname, './routes/views/html/...'));
});
*/
...
/*
app.get('/myBar/bar/configuracion_menu/anadir_comidas', (req, res) => {
    res.sendFile(path.resolve(__dirname, './routes/views/html/...'));
});
*/
...
/*
app.get('/myBar/bar/configuracion_bar', (req, res) => {
    res.sendFile(path.resolve(__dirname, './routes/views/html/...'));
});
*/
...
app.get('/myBar/administrador', (req, res) => {
    res.sendFile(path.resolve(__dirname, './routes/views/html/administrador/administrador.html'));
});


// Ruta para la creacion de comidas [http://localhost:3000/myBar/administrador/crear_comida]
/*
app.get('/myBar/administrador/crear_comida', (req, res) => {
    res.sendFile(path.resolve(__dirname, './routes/views/html/...'));
});
*/
...
/*
app.get('/myBar/administrador/visualizar_comidas', (req, res) => {
    res.sendFile(path.resolve(__dirname, './routes/views/html/...'));
});
*/
...
/*
app.get('/myBar/administrador/anadir_usuario_bar', (req, res) => {
    res.sendFile(path.resolve(__dirname, './routes/views/html/...'));
});
*/
...
app.use((req, res, next) => {
    res.status(404).sendFile(path.resolve(__dirname, './routes/views/html/respuestas/error_404.html'));
});